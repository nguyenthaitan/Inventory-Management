      ...
      <div className="flex items-center justify-between">
        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm text-gray-500 font-medium">
            ...
            <div className="flex items-center gap-1">
              <MapPin size={14} /> Kho A-1
            </div>
            <div className="flex items-center gap-1">
              <Calendar size={14} /> 2026-03-01
            </div>
          </div>
        </div>
...
<div className="space-y-4 animate-in fade-in duration-300">
  ...
  <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm flex flex-col md:flex-row gap-4 items-center justify-between">
    ...
    <button
      disabled
      className="flex items-center gap-2 px-6 py-2 rounded-lg font-bold transition bg-gray-100 text-gray-400 cursor-not-allowed"
    >
...
<div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm">
  ...
  <div className="bg-white rounded-2xl shadow-2xl max-w-lg w-full overflow-hidden border border-gray-200 animate-in zoom-in-95">
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="bg-blue-50 p-4 rounded-xl border border-blue-100">
        ...
        <p className="text-sm text-gray-600">
          Vị trí hiện tại: <span className="font-bold">Kho A-1</span>
        </p>
      </div>
    ...
    <div className="p-4 bg-gray-50 border-t flex justify-end">
      <button onClick={onClose} className="px-6 py-2 text-gray-500 font-bold">
        Đóng
      </button>
    </div>
  </div>
...
> _Tài liệu được tạo tự động từ phân tích mã nguồn. Cập nhật lần cuối: 09/03/2026._
