...
db.materials.insertMany([
  ...
  },
  {
    ...
    specification_document: "SPEC-PKG-001",
    created_date: new Date(),
    modified_date: new Date(),
  },
  {
    ...
    storage_conditions: "Room temperature",
    specification_document: "SPEC-PKG-002",
    created_date: new Date(),
    modified_date: new Date(),
  },
  {
...
db.inventory_lots.insertMany([
  ...
  },
  {
    ...
    status: "Accepted",
    quantity: NumberDecimal("5000.000"),
  ...
  },
  {
    ...
    status: "Accepted",
    quantity: NumberDecimal("10000.000"),
    unit_of_measure: "each",
    storage_location: "WH-D-Packaging",
    is_sample: false,
  ...
  },
  {
    ...
    status: "Accepted",
    quantity: NumberDecimal("2500.000"),
    unit_of_measure: "each",
